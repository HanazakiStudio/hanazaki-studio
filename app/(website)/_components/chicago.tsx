  ...
  return (
    <section className="w-full px-6 py-16 sm:px-16 sm:py-24 lg:py-32">
      <motion.div
        ...
        className="w-full max-w-6xl mx-auto flex flex-col items-center gap-y-10 lg:flex-row lg:gap-x-16 lg:items-center lg:justify-center"
      >
        {/* VÍDEO */}
        <motion.div
          variants={ChicagoItemAnimation}
          className="relative w-full max-w-[280px] sm:max-w-[320px] aspect-[9/16] rounded-2xl overflow-hidden shrink-0 bg-black"
        >
          <video
            ref={videoRef}
            src="/chicago.webm"
        ...
        >
          ...
          <p className="poppins-font text-base font-normal text-light-primary leading-relaxed sm:text-lg">
            ...
            concreto no caminho de mostrar a tecnologia brasileira pra fora do
            país.
          </p>
        </motion.div>
      </motion.div>

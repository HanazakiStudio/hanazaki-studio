    ...
    <footer className="w-full mt-12 sm:mt-24">
      ...
      >
        ...
        <div className="flex items-start justify-center">
          <Link
            href="/"
            className="relative w-28 h-28 sm:w-36 sm:h-32 lg:w-44 lg:h-44"
          >
            <Image
        ...
        {/* SOCIAL */}
        <div className="flex flex-col justify-start gap-12 w-full sm:w-auto pt-[6px]">
          <SocialMediaLink
      ...
      {/* BOTTOM */}
      <div
        className="w-full mt-12 py-6 border-t border-light-primary px-6
